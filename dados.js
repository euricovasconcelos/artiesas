...
const DADOS = {
  ...
  fiscal: [
    ...
    { titulo: "Mecenato desportivo",
      ...
      texto: "Sendo a AESAS um agrupamento de escolas público, o donativo pode ser documentado por esta entidade, permitindo deduzir o apoio ao abrigo do Estatuto dos Benefícios Fiscais. Em IRC pode ainda beneficiar de majoração do valor considerado para efeitos fiscais, dentro dos limites legais aplicáveis. Todos os valores deverão ser transferidos de forma identificada para a conta do Agrupamento de Escolas Alberto Sampaio – AESAS  - CONTA Nº 91120001736 - IBAN PT50 0781 0112 9112 0001 73614 - SWIFT/BIC: IGCPPTPL.",
      realce: true },
  ],
  fiscalIrs: {
...
/* ==========================================================================
  ...
  ========================================================================== */
  atletas: [
    { nome: "Ana Liz Vasconcelos", atuacao: "ginasta - base", desde: "-", foto: "imagens/img0.jpg" },
    { nome: "Diego Silva", atuacao: "ginasta - base", desde: "-", foto: "imagens/img1.jpg" },
    { nome: "Bruna Camelo",   atuacao: "ginasta - base", desde: "-", foto: "imagens/img2.jpg" },
    { nome: "Matilde Nunes",    atuacao: "ginasta - base", desde: "-", foto: "imagens/img3.jpg" },
    { nome: "Mafalda Cunha",    atuacao: "ginasta - base",    desde: "-", foto: "imagens/img4.jpg" },
    { nome: "Francisca Morais",     atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img5.jpg" },
    { nome: "Camila Salgueiro",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img6.jpg" },
    { nome: "Margarida coimbra",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img7.jpg" },
    { nome: "Matilde Cunha",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img8.jpg" },
    { nome: "Leonor Ferreira",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img9.jpg" },
    { nome: "Inês Veloso",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img10.jpg" },
    { nome: "Mariana Arantes",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img11.jpg" },
    { nome: "Frederica Carvalho",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img12.jpg" },
    { nome: "Beatriz Fernandes",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img13.jpg" },
    { nome: "Margarida Sousa",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img14.jpg" },
    { nome: "Ainaf Oliveira",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img15.jpg" },
    { nome: "Isabel Sousa (Max)",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img16.jpg" },
    { nome: "Clara Barros",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img17.jpg" },
    { nome: "Maria Inês",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img18.jpg" },
    { nome: "Maria Pereira",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img19.jpg" },
    { nome: "Yasmin",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img20.jpg" },
    { nome: "Ires Pereira",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img21.jpg" },
    { nome: "Maria Inês",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img22.jpg" },
    { nome: "Beatriz Costa",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img23.jpg" },
    { nome: "Mariana Gomes",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img24.jpg" },
    { nome: "Lara Mota",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img25.jpg" },
    { nome: "Yadi Carvalho",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img26.jpg" },
    { nome: "Mariana Vieira",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img27.jpg" },
    { nome: "Inês Xavier",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img28.jpg" },
    { nome: "Maria Luisa",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img29.jpg" },
    { nome: "Matilde Faria",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img30.jpg" },
    { nome: "Bruna Ferreira",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img31.jpg" },
    { nome: "Lara Cortizas",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img32.jpg" },
    { nome: "Caroline Peixoto",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img33.jpg" },
    { nome: "Matilde Lima",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img34.jpg" },
    { nome: "Leonor Alves",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img35.jpg" },
    { nome: "Matilde Brito",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img36.jpg" },
    { nome: "Maria Cecília",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img37.jpg" },
    { nome: "Maria Vicente",  atuacao: "ginasta - base",    desde: "-", foto: "imagens/img38.jpg" },
    { nome: "Camila Peixoto",  atuacao: "ginasta - volante",    desde: "-", foto: "imagens/img39.jpg" },
      ],
  ...
  competicoes: [
    ...
    { titulo: "Festival Artigym",                  data: "4 de julho de 2026", local: "Forum Braga", descricao: "Apresentação anual do grupo perante a comunidade.",                                   tag: "Festival",      estado: "realizada", foto: "imagens/artiesas.jpg" },
    { titulo: "World Gymnaestrada 2027",           data: "2027", local: "Lisboa",      descricao: "1.ª participação do ARTIESAS, com 43 atletas, num evento que reúne mais de 20.000 participantes dos 5 continentes.", tag: "Internacional", estado: "futura", foto: "imagens/Gymnaestrada2027.jpg" },
